...
<div class="container">
  <div class="row">
    <div class="well">
      <h3>Body Transformation Program - 3 Months</h3>
      <h4>$120.00 USD</h4>
    </div>
    <div class="col-sm-7">
        <form class="register" action="popup.php" method="POST">
        ...
        <?php } ?>
          ...
          <li> <input type="hidden" name="package" value="body transformation"> </li>
    ...
    <div class="col-sm-5">
      ...
      <h3>Take the 3 Months Challenge</h3>
