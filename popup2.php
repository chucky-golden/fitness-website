  ...
  if (isset($_POST['create'])) {
    ...
    if (empty($error)) {
      ...
      if (mysqli_num_rows($check_result) == 1) {
        ...
        header("location: package2.php?error=".$exist);
      }else{
        $new_password= md5($password);
        $main_date =  date("Y-m-d h:i:sa");

         $expire = date('Y-m-d h:i:sa', strtotime($main_date. ' + 30 days'));
          ...
          if (mysqli_num_rows($resultt) > 0) {
            while ($roww = mysqli_fetch_assoc($resultt)) {
              ...
              if(isset($_SESSION['id'])){
                ...
                header("location: package2.php?error=".$failed);
              }
            }
          }
      ...
      header("location: package2.php?error=".join($error, urlencode('<br>')));
    }
  }
...
<body class="log">
  ...
  <div class="log_box">
      ...
      <form>
        ...
        <b>30 Days "GET FIT Challenge"</b> <br> <br>
